#Faça um programa que pergunte ao usuário se ele possui irmãos, e que, caso a resposta seja “sim”, pergunte quantos e mostre na tela uma mensagem de sua escolha. No caso de o usuário responder “não”, 
...
def tem_irmaos(resposta):
    if resposta == "Sim" or resposta == "sim":
        ...
        if resposta_2 == "sim" or resposta_2 == "Sim":
            ...
            return "Tudo bem, agradecemos pela resposta"
